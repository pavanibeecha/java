...
public class Demo360_ByClassName {
	...
	public static By sectionId = By.xpath("//select[contains(@id,'section_id')]");
	...
	public void selecting(String webele, int index) {
		WebElement drpdn = driver.findElement(By.id("+webele+"));
		drpdn.click();
