...
public class DemoAutoReports {
	...
	public void extentReportSetup() {
		...
		//extent.setSystemInfo("Envirnoment", config.environment);		
	}
	...
	public void loadURL() throws InterruptedException {
		...
		test.info("Login Test executed Successfully");
		...
		test.info("Exam click Test executed Successfully");
		//CLASS NAME
